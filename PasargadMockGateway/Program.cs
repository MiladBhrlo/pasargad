...
// تعریف متغیرهای JWT در سطح کلاس
public class Program
{
    private static readonly string JwtKey = "YourSuperSecretKey123!@#$%^&*()_+";
    private static readonly string JwtIssuer = "PasargadMockGateway";
    private static readonly string JwtAudience = "PasargadMockGatewayClient";
    ...
    public static void Main(string[] args)
    {
        ...
        // اضافه کردن میدلورهای احراز هویت با ترتیب صحیح
        app.UseRouting();
