...
{
    public static readonly Dictionary<int, (string EnglishMessage, string PersianMessage)> ErrorMessages = new()
    {
        ...
        { 13030, ("transaction before is verified and it's failed", "تراکنش تاییده شده و ناموفق است") },
        ...
        { 13316, ("Settlement transaction must be confirm or reverse", "اصل تراکنش مالی موفق نمیباشد") },
        ...
        { 13324, ("Original transaction was not success", "اصل تراکنش مالی موفق نمیباشد") },
        { 13325, ("Original transaction was not Found", "اصل تراکنش یافت نشد") },
        { 13326, ("Card blocked by machine", "کارت مسدود است") },
        { 13327, ("Card blocked by machine for special condition", "کارت به دلیل ویژه مسدود شده است") },
        ...
        { 13335, ("Response lost card", "کارت گم شده است") },
        ...
        { 13404, ("Failed Type Conversion", "خطا در تغییر نوع متغییر") },
    ...
    {
        return ErrorMessages.TryGetValue(errorCode, out var messages) ? messages.EnglishMessage : "Unknown error";
    }

    public static string GetPersianMessage(int errorCode)
    {
        return ErrorMessages.TryGetValue(errorCode, out var messages) ? messages.PersianMessage : "خطای نامشخص";
    }
} 